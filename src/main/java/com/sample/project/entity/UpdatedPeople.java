...
@Entity
@Table(name = "UPDATED_PEOPLE")
public class UpdatedPeople {
	...
	public UpdatedPeople() {

	}

	public UpdatedPeople(Long personalNumber, String name, String gender, String job,
			String position, String setup1, String setup2, String setup3, String setup4,
			String date) {
		super();
